...
def check_env_vars():
    if os.environ.get("OUTPUT_MODEL_DIR") is None:
        # make a warning
        warnings.warn(
            "OUTPUT_MODEL_DIR is not set. Defaulting to current directory. This is likely not what you want!"
        )
        os.environ["OUTPUT_MODEL_DIR"] = os.getcwd()
