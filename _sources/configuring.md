...
Once ClimatExML is installed and PyTorch and GPUs have been verified, there are two main configurations that should be considered. The (1) `mlflow.env` file and (2) the `ClimatExML/conf/config.yaml` file.
